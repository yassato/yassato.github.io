---
title: Quantitative Ecological Genetics
...
We are interested in how genetic variation shapes, and is shaped by, biotic interactions. To analyze quantitative genetic variation in complex ecological traits, our research employs cutting-edge tools from computational biology and functional genomics. Currently, we are working on plant-plant interactions, but other projects involving biotic interactions are also welcome.  
**Keywords: Genetics of complex traits, Plant-plant interaction, Plant-insect interaction**  

#### **1. Quantitative Genetics of Plant-Plant Interactions**  
Plants cannot escape from neighboring individuals in the field. Although such neighboring plant-plant interactions are ubiquitous, they are not always attributable to a single trait or gene. To dissect the genetic architecture of neighbor effects, I have developed new methods called "Neighbor GWAS" (Sato et al. 2021 Heredity) and "Neighbor QTL" (Sato et al. 2021 G3). These new methods are being applied to the analysis of quantitative trait variation in insect herbivory and communities on *Arabidopsis thaliana* accessions (Sato et al. 2023 bioRxiv) in addition to other traits in crops, trees, and so on.  
...
#### **2. Herbivore-mediated Maintenance of Polymorphism in Plant Defense**  
Herbivory risk depends on neighboring plants as well as plants’ own traits. Such neighbor effects can exert frequency-dependent selection on plant defense when they occur among plant genotypes within a species (reviewed by Sato 2018 Plant Species Biology). Our study uncovered that hairy plants were less damage by a leaf beetle when surrounded by glabrous plants, which results in negative frequency-dependent selection on the *GLABRA1*-based trichome dimorphism in the wild herb *Arabidopsis halleri* (Sato & Kudoh 2017 The American Naturalist; Sato et al. 2017 Functional Ecology).
...
To untangle complex ecological interactions, our research often employs statistical tools. This experience enables me to not only develop new methods (Sato et al. 2023 Evolution) but also collaborate with other research areas (e.g., Nakadai et al. 2018 Oecologia; Shimizu-Inatsugi et al. 2021 Plant Species Biology; Takimoto & Sato et al. 2021 Ecological Informatics). Data from plant ecology and genomics are especially welcome for collaboration.  
...
- 2017.10 - 2021.03: Junior group leader of [Precursory Research for Embryonic Science and Technology](https://www.jst.go.jp/kisoken/presto/en/project/1112074/1112074_26.html) (PRESTO) project of Japan Science and Technology Agency (JST), Japan
- 2016.04 - 2017.09: Independent postdoctoral fellow of Japan Society for the Promotion of Science (JSPS), Japan (advisor: Assoc. Prof. [Atsushi J. Nagano](https://researchmap.jp/anagano/?lang=english)\)
- 2015.04 - 2016.03: Research Fellowship for PhD students (DC2), JSPS, Japan

*Full CV is available [here](./cv/CV_YasuhiroSato.pdf)*
